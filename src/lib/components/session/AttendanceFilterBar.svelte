...
<style>
  .controls-bar { display: flex; align-items: center; justify-content: space-between; gap: 12px; flex-wrap: wrap; background: rgba(16, 9, 4, 0.6); border: 1px solid var(--color-cork-border); border-radius: 8px; padding: 10px 14px; margin-bottom: 12px; }
  .search-wrap { position: relative; display: flex; align-items: center; flex: 1; min-width: 200px; max-width: 320px; }
  :global(.search-icon) { position: absolute; left: 10px; color: var(--color-warm-cream-dim); pointer-events: none; }
  .search-input { width: 100%; padding: 7px 28px 7px 32px; background: rgba(10, 5, 2, 0.8); border: 1px solid var(--color-cork-border); border-radius: 6px; color: var(--color-warm-cream); font-size: 12px; }

<script lang="ts">
  ...
  import {
    copyInvite, endSession, importFile, parseRoster, publishCaption, refreshAttendance, startSession
...
<div class="lecturer-workspace-wrap">
  <LecturerHeader currentUser={appState.currentUser} liveCode={appState.session?.live ? appState.session.code : undefined} />

...
<style>
  .roster-preview-summary { display: flex; gap: var(--spacing-8); margin-block: 4px; }
  .summary-badge { font-size: 10px; padding: 3px 8px; border-radius: 4px; text-transform: uppercase; letter-spacing: 0.06em; }
  ...
  .mapping-table-wrap { background: rgba(16, 9, 4, 0.4); border: 1px solid var(--color-cork-border); border-radius: 6px; padding: 8px; overflow-x: auto; }
  .mapping-table { width: 100%; font-size: 11px; border-collapse: collapse; text-align: left; }
  .mapping-table th { color: var(--color-driftwood); font-size: 9px; letter-spacing: 0.1em; text-transform: uppercase; padding: 6px 8px; border-bottom: 1px solid var(--color-cork-border); }
  .mapping-table td { padding: 6px 8px; border-bottom: 1px solid rgba(64, 55, 46, 0.4); color: var(--color-warm-cream); }
  .status-tag.match { font-size: 9px; text-transform: uppercase; color: #4ab772; }
  .table-more-hint { font-size: 10px; color: var(--color-driftwood); margin-top: 6px; text-align: center; }
</style>

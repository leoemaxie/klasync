...
<section class="join-wrap">
  <div class="join-left-content">
    ...
    <p class="lede">
      An account unlocks your claimed lecture materials. Joining live lectures remains account-free.
    </p>
    ...
    <form class="join-card panel" onsubmit={handleRegister}>
      ...
      <label>
        Email Address
        <input type="email" bind:value={email} placeholder="ada@student.edu" required />
      </label>
      ...
      <button type="submit" class="primary full" disabled={isSubmitting}>
        {isSubmitting ? "Creating Account..." : "Create Account & Retain Materials"}
      </button>
  ...
  <PublicVisualPanel title="STUDENT LEARNING PERSISTENCE" subtitle="Claimed Lectures · Audio Replay · AI Notes" />
</section>
